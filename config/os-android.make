...
INCLUDES    += `pkg-config libavformat libswresample libavcodec libavutil`
...
#INCLUDES    += `pkg-config blas`
INCLUDES    += -I/home/sleepy/Documents/androidRASR/deps/blas/output/arm64-v8ainclude
#INCLUDES    += `pkg-config lapack`
#LDFLAGS     += `pkg-config --libs blas`
LDFLAGS     += -L/home/sleepy/Documents/androidRASR/deps/blas/output/arm64-v8a
#LDFLAGS     += `pkg-config --libs lapack`
#LDFLAGS     += -l:liblapack.a
endif
endif
